...
<nav ref={headerRef} className={`${headerRef.current && scrollTop > headerRef.current.clientHeight ? 'box-shadow-custom bg-white/70 backdrop-blur-xl w-full' : 'bg-white w-full'}`}>
