...
<div id="our-team" className="flex justify-center flex-col items-center font-ysabeau pb-5">
    ...
    Meet our Agents</h3>
    <p className="text-xl pb-5 bg-gradient-to-r from-rose-600 to-rose-900 bg-clip-text text-transparent">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.
</p>
