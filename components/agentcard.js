...
const AgentCard = ({ name, title }) => (
  <>
<div className="relative w-full p-6 h-96 group transition">
      <img
        className="absolute inset-0 object-cover w-full h-full"
        src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png"
        alt="photo of the agent"
      />
      <div className="absolute inset-x-0 bottom-0 px-4 pb-6 group-hover:pb-8 pt-32 bg-gradient-to-t from-black to-transparent">
